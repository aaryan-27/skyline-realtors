...
export const PROJECTS: Project[] = [
  {
    ...
    configurations: [
      { type: "3 BHK Floor · 250 sq.yd.", area: "2,000 sq.ft.", price: "Rs.2.60 Cr onwards" },
      { type: "4 BHK Floor · 360 sq.yd.", area: "2,600 sq.ft.", price: "Rs.3.25 Cr onwards" },
      { type: "4 BHK Floor · 520 sq.yd.", area: "3,600 sq.ft.", price: "Rs.4.5 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    configurations: [
      { type: "3 BHK", area: "1,850 sq.ft.", price: "Rs.2.65 Cr onwards" },
      { type: "3 BHK + Study", area: "2,100 sq.ft.", price: "Rs.2.9 Cr onwards" },
      { type: "4 BHK", area: "2,600 sq.ft.", price: "Rs.3.6 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    configurations: [
      { type: "Plot · 360 sq.yd.", area: "360 sq.yd.", price: "Rs.3.0 Cr onwards" },
      { type: "Plot · 520 sq.yd.", area: "520 sq.yd.", price: "Rs.5.5 Cr onwards" },
      { type: "Corner Plot · 720 sq.yd.", area: "720 sq.yd.", price: "Rs.8.5 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    amenities: FLOOR_AMENITIES,
    configurations: [
      { type: "3 BHK Floor · 270 sq.yd.", area: "2,100 sq.ft.", price: "Rs.2.70 Cr onwards" },
      { type: "3 BHK Floor · 300 sq.yd.", area: "2,300 sq.ft.", price: "Rs.2.9 Cr onwards" },
      { type: "4 BHK Floor · 360 sq.yd.", area: "2,600 sq.ft.", price: "Rs.3.25 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    amenities: FLOOR_AMENITIES,
    configurations: [
      { type: "3 BHK Floor · 250 sq.yd.", area: "1,950 sq.ft.", price: "Rs.2.60 Cr onwards" },
      { type: "4 BHK Floor · 300 sq.yd.", area: "2,300 sq.ft.", price: "Rs.3.0 Cr onwards" },
      { type: "4 BHK Floor · 360 sq.yd.", area: "2,600 sq.ft.", price: "Rs.3.7 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    featured: true,
    tags: ["Builder Floor", "Sector 23", "New Launch"],
    heroImage: IMG.floor2,
    gallery: [IMG.floor2, IMG.interior, IMG.flat1, IMG.lobby],
    highlights: [
      "Premium floors in a quiet, upscale Sector 23 pocket",
      "Spacious 3 & 4 BHK layouts with private terraces",
      "Low-density, low-traffic streetscape",
    ],
    amenities: FLOOR_AMENITIES,
    configurations: [
      { type: "3 BHK Floor · 300 sq.yd.", area: "2,300 sq.ft.", price: "Rs.3.0 Cr onwards" },
      { type: "4 BHK Floor · 360 sq.yd.", area: "2,700 sq.ft.", price: "Rs.3.9 Cr onwards" },
      { type: "4 BHK Floor · 520 sq.yd.", area: "3,600 sq.ft.", price: "Rs.4.5 Cr onwards" },
    ],
    about:
      "Royal Floors is a new-launch collection of premium builder floors in the calm, upscale Sector 23. Early-stage pricing, spacious layouts and a low-density setting make it attractive for quality-conscious families and long-term investors alike.",
  },
  {
    ...
    configurations: [
      { type: "Plot · 360 sq.yd.", area: "360 sq.yd.", price: "Rs.3.0 Cr onwards" },
      { type: "Plot · 520 sq.yd.", area: "520 sq.yd.", price: "Rs.6.0 Cr onwards" },
      { type: "Plot · 800 sq.yd.", area: "800 sq.yd.", price: "Rs.9.5 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    configurations: [
      { type: "3 BHK", area: "1,900 sq.ft.", price: "Rs.2.75 Cr onwards" },
      { type: "3 BHK + Study", area: "2,150 sq.ft.", price: "Rs.2.85 Cr onwards" },
      { type: "4 BHK", area: "2,500 sq.ft.", price: "Rs.3.25 Cr onwards" },
    ],
    about:
  ...
  },
  {
    ...
    amenities: FLOOR_AMENITIES,
    configurations: [
      { type: "3 BHK Floor · 270 sq.yd.", area: "2,150 sq.ft.", price: "Rs.2.80 Cr onwards" },
      { type: "4 BHK Floor · 360 sq.yd.", area: "2,600 sq.ft.", price: "Rs.3.25 Cr onwards" },
      { type: "4 BHK Floor · 400 sq.yd.", area: "2,900 sq.ft.", price: "Rs.3.8 Cr onwards" },
    ],
    about:
  ...
  {
    slug: "urban-nest-plots-sector-23",
    ...
    possession: "Ready to Move",
    possessionDate: "Ready",
    rera: "GGM/488/222/2022/S23/08",
    featured: false,
    tags: ["Plots", "Sector 23", "Clear Title"],
    heroImage: IMG.plot,
    gallery: [IMG.plot, IMG.floor2, IMG.commercial, IMG.flat2],
    highlights: [
      "Clear-title plots in a quiet, upscale Sector 23 pocket",
    ...
    configurations: [
      { type: "Plot · 360 sq.yd.", area: "360 sq.yd.", price: "Rs.3.0 Cr onwards" },
      { type: "Plot · 520 sq.yd.", area: "520 sq.yd.", price: "Rs.5.5 Cr onwards" },
      { type: "Corner Plot · 650 sq.yd.", area: "650 sq.yd.", price: "Rs.7.5 Cr onwards" },
    ],
    about:
      "Urban Nest Plots offers clear-title residential plots in the calm, low-density Sector 23. Ideal for building a bespoke home or holding as a scarce land asset, each plot comes with verified title and ready access to utilities.",
  },
];
